...
#include <G4Tubs.hh>
#include "gneis/facility/component/BoxComponent.hh"

G4double gneis::facility::component::BoxComponent::HalfOf(G4double const v) {
	return 0.5 * v;
}

G4VSolid* gneis::facility::component::BoxComponent::MakeCylinder(
