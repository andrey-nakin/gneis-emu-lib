...
TEST(Beam5Messenger, SetAngle)
{
	...
	EXPECT_EQ(0, uiManager->ApplyCommand("/isnp/beam5/angle 25 deg"));
...
TEST(Beam5Messenger, SetHaveCollimator1)
{
	...
	EXPECT_EQ(0, uiManager->ApplyCommand("/isnp/beam5/haveCollimator1 true"));
...
TEST(Beam5Messenger, SetHaveCollimator2)
{
	...
	EXPECT_EQ(0, uiManager->ApplyCommand("/isnp/beam5/haveCollimator2 true"));
...
TEST(Beam5Messenger, SetHaveCollimator3)
{
	...
	EXPECT_EQ(0, uiManager->ApplyCommand("/isnp/beam5/haveCollimator3 true"));
...
TEST(Beam5Messenger, SetHaveCollimator4)
{
	...
	EXPECT_EQ(0, uiManager->ApplyCommand("/isnp/beam5/haveCollimator4 true"));
...
TEST(Beam5Messenger, SetHaveCollimator5)
{
	...
	EXPECT_EQ(0, uiManager->ApplyCommand("/isnp/beam5/haveCollimator5 false"));
